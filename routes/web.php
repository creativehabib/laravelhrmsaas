...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    // Nu Data Route
    Route::get('ajax_nudatas/', ['as' => 'admin.nu_datas', 'uses' => 'NudataController@ajaxNuDatas']);
    Route::resource('nu_datas', 'NudataController', ['as' => 'admin']);

     Route::get('downloadpdf/', ['as' => 'admin.pdf', 'uses' => 'NudataController@pdf']);


     Route::get('singal_data/{id}', ['as' => 'admin.singal_data', 'uses' => 'NudataController@show_data']);
